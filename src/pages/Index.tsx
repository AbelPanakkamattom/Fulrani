        ...
        <section className="relative overflow-hidden bg-accent/30 min-h-[80vh] flex items-center">
          <div className="container grid lg:grid-cols-2 gap-10 py-16">
            ...
            <div className="relative hidden lg:block">
              <img src={heroBanner} alt="Fulrani Advertising creative team collaborating on marketing campaigns" className="rounded-2xl shadow-elevated object-cover w-full h-[480px]" />
            </div>
          </div>
        </section>
