          ...
          <TableBody>
            {items.map((i) => (
              <TableRow key={i.id}>
                ...
                <TableCell className="text-right space-x-2">
                  <Button size="icon" variant="ghost" onClick={() => handleEdit(i)}><Pencil className="h-4 w-4" /></Button>
                  <Button size="icon" variant="ghost" onClick={() => { videoStore.delete(i.id); refresh(); }}><Trash2 className="h-4 w-4 text-destructive" /></Button> variant="ghost" onClick={() => { videoStore.delete(i.id); refresh(); }}><Trash2 className="h-4 w-4 text-destructive" /></Button>><Trash2 className="h-4 w-4 text-destructive" /></Button>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
