        ...
        <section className="py-16">
          <div className="container grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              {[
                { city: "Mumbai (Head Office)", address: "D-33, Penta Galaxy, S.M Road, Wadala East, Mumbai - 400037", phone: "+91 9773016354", email: "mumbai@fulrani.com"},
                { city: "Pune", address: "456 Tech Park, Hinjewadi, Pune - 411057", phone: "+91 9969352797", email: "pune@fulrani.com"},
                { city: "Delhi", address: "789 Corporate Tower, Connaught Place, Delhi - 110001", phone: "+91 9969352797", email: "delhi@fulrani.com"},
              ].map((o) => (
                <div key={o.city} className="bg-card rounded-xl p-5 shadow-card">
                  ...
                  <p className="text-sm text-muted-foreground flex items-center gap-2 mt-1"><Mail className="h-4 w-4 shrink-0" />{o.email}</p>
                </div>
              ))}
